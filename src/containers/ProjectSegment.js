...
class ProjectSegment extends Component {
  constructor(props) {
    ...
    this.goSegments = this.goSegments.bind(this);
  }
        ...
        <div className="project-container">
          <Breadcrumb className="custom-breadcrumb">
            <Col md={6} className="no-padding">
              ...
              <Breadcrumb.Item className="breadcrumb-item" onClick={this.goSegments}>
                <div>
                  <i className="fa fa-folder-open breadcrumb-text" aria-hidden="true" />
                  <span className="breadcrumb-text margin-l-5">
                    Segments
                  </span>
                </div>
...
export default connect(mapStateToProps)(ProjectSegment);
