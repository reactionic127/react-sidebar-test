...
class Sidebar extends Component {
  ...
  render() {
    const {selected, projectDetail} = this.props;
    return (
      <div className="sidebar-container">
        ...
        <div className="user-info">
          ...
          <div className="icon-group">
            <i className="fa fa-cog fa-lg custom-icon" aria-hidden="true" />
            <i className="fa fa-building fa-lg custom-icon margin-l-20" aria-hidden="true" />
            <i className="fa fa-commenting fa-lg custom-icon margin-l-20" aria-hidden="true" />
          </div>
        </div>
        ...
        <div className="project-side-view">
          ...
          <div className="global-group">
            <div className="global-project" onClick={this.goOverView}>
              <i className={selected === 'overview' ? 'fa fa-tachometer custom-selected-icon' : 'fa fa-tachometer custom-icon'} aria-hidden="true" />
              <span className={selected === 'overview' ? 'global-selected-text' : 'global-text'}>
                                    Overview
              </span>
            </div>
            <div className="global-project" onClick={this.goData}>
              <i className={selected === 'data' ? 'fa fa-folder-open custom-selected-icon' : 'fa fa-folder-open custom-icon'} aria-hidden="true" />
              <span className={selected === 'data' ? 'global-selected-text' : 'global-text'}>
                                    Data
              </span>
            </div>
            <div className="global-project" onClick={this.goSegment}>
              <i className={selected === 'segments' ? 'fa fa-pie-chart custom-selected-icon' : 'fa fa-pie-chart custom-icon'} aria-hidden="true" />
              <span className={selected === 'segments' ? 'global-selected-text' : 'global-text'}>
                                    Segments
              </span>
            </div>
            <div className="global-project" onClick={this.goLists}>
              <i className={selected === 'lists' ? 'fa fa-list custom-selected-icon' : 'fa fa-list custom-icon'} aria-hidden="true" />
              <span className={selected === 'lists' ? 'global-selected-text' : 'global-text'}>
                                    Lists
              </span>
            </div>
            <div className="global-project" onClick={this.goSettings}>
              <i className={selected === 'settings' ? 'fa fa-cog custom-selected-icon' : 'fa fa-cog custom-icon'} aria-hidden="true" />
        ...
        <div className="category-view">
          ...
          <div className="global-group">
            <div className="global-project" onClick={this.goProject}>
              <i className={selected === 'projects' ? 'fa fa-folder custom-selected-icon' : 'fa fa-folder custom-icon'} aria-hidden="true" />
              <span className={selected === 'projects' ? 'global-selected-text' : 'global-text'}>
                                Projects
              </span>
            </div>
            <div className="global-project" onClick={this.goLogout}>
              <i className={selected === 'logout' ? 'fa fa-sign-out custom-selected-icon' : 'fa fa-sign-out custom-icon'} aria-hidden="true" />
